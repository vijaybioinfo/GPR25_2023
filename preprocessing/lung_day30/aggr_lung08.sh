...
#PBS -N aggr_exp1
#PBS -o /home/fcastaneda/fcastaneda/rnaseq-sc-standar/gpr25/lung08/raw/cellranger/scripts/aggr_all.out.txt
#PBS -e /home/fcastaneda/fcastaneda/rnaseq-sc-standar/gpr25/lung08/raw/cellranger/scripts/agge_all.err.txt
...
PROJDIR=/home/fcastaneda/fcastaneda/rnaseq-sc-standar/gpr25/lung08/raw/cellranger/
...
{
  # {pre_routine}
  /home/ciro/bin/cellranger-3.1.0/cellranger aggr --id=gpr25_all --csv=/home/fcastaneda/fcastaneda/rnaseq-sc-standar/gpr25/lung08/info/GPR25_Batches-1-to-7_aggr_table_annotated.0.1.csv --normalize=mapped --localcores=6 --localmem=30 --disable-ui
  # {post_routine}
}
